    ...
    return (
      <div key={round._id || index} className="relative">
        ...
        <div className={`mb-8 flex items-start gap-6 relative z-10 ${isCurrentRound ? 'opacity-100' : (isPastRound ? 'opacity-90' : 'opacity-60')}`}>
          ...
          <div className={`flex-1 transition-all duration-300 ${isCurrentRound ? 'transform scale-105' : ''}`}>
            <Card className={`overflow-hidden transition-all ${
            ...
            } ${isCurrentRound ? 'bg-white' : isPastRound ? 'bg-gray-50' : 'bg-gray-50/50'}`}>
              ...
              <CardContent>
                ...
                {roundStatus && roundStatus.score !== undefined && roundStatus.score !== null && (
                  <div className="mb-3">
