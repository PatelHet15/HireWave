          ...
          await axios.post(
            `${USER_API_END_POINT}/send-email`,
            {
              ...
              data: {
                ...
                nextSteps: `Thank you for your interest in our company. We encourage you to apply for future positions that match your qualifications and experience. We wish you the best in your job search.`,
                companyName: jobData?.company?.name || 'HireWave',
                position: jobData?.title || 'the position',
                companyAddress: jobData?.company?.location || jobData?.location || 'Remote',
                contactEmail: jobData?.company?.email || 'contact@hirewave.com',
      ...
      <div className="max-w-7xl mx-auto pt-10 px-4 pb-20">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            {selectedApplication && (
              <Badge variant="outline" className={`px-3 py-1 ${StatusColors[selectedApplication.status] || StatusColors.pending}`}>
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2 items-center">
                  <p className="text-gray-600">{`${candidate.profile?.courseField} | ${candidate.profile?.courseName}`}</p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      {candidate.profile?.about || 'No information provided'}
                    </p>
                  </div>
                      ...
                      <div className="space-y-3">
                        ...
                        {candidate.profile?.phone && (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-900">{candidate.profile.phone}</span>
                          </div>
                        )}
                      ...
                      <div className="space-y-3">
                        ...
                        {candidate.profile?.education && candidate.profile.education.length > 0 && (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-900">{candidate.profile.education[0].degree}</span>
                          </div>
                        )}
                        ...
                        {candidate.profile?.title && (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-900">{candidate.profile.title}</span>
                          </div>
                        )}
                      </div>
                    </div>
            ...
            <Card>
              ...
              <CardContent>
                ...
                {candidate.profile?.employmentHistory && candidate.profile.employmentHistory.length > 0 ? (
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-100 text-center mb-8">
                ...
                {candidate.profile?.internships && candidate.profile.internships.length > 0 ? (
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-100 text-center">
                    <p className="text-gray-500">No internship experience available</p>
                  </div>
                )}
              </CardContent>
            </Card>
