        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-5">
          <div className="flex justify-between items-center mb-4">
            <h2 className="font-semibold text-gray-800 flex items-center">
              <Star className="h-4 w-4 mr-1.5 text-blue-500" />
                  ...
                  >
                    ...
                    <button
                      className={`absolute top-3 right-3 z-10 p-1.5 rounded-full transition-all duration-200 ${
                        bookmarkedJobs[job._id] ? 'bg-blue-100 text-blue-600' : 'bg-white/70 backdrop-blur-sm text-gray-400 hover:text-blue-500 hover:bg-white shadow-sm'
                      }`}
                      onClick={(e) => handleBookmarkClick(e, job._id)}
                      aria-label={bookmarkedJobs[job._id] ? "Remove from bookmarks" : "Add to bookmarks"}
                    >
                    ...
                    <div className="absolute top-3 left-3 z-10">
                      <div className="inline-flex items-center bg-gradient-to-r from-blue-500 to-blue-600 px-2 py-0.5 rounded-full text-white text-xs font-medium shadow-sm">
                        <MapPin className="h-3 w-3 mr-1" fill="white" />
                        Nearby
                      </div>
                    </div>
