...
const FilterCard = ({ onFilterChange, onLoad }) => {
  ...
  return (
    <div className='bg-white p-5 rounded-xl shadow-sm border border-gray-200 hover:border-blue-100 transition-all duration-200'>
